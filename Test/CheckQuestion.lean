...
@[invProof] theorem Ring.send_single_leader :
      ∀ (st st' : @State node),
        (@System node node_dec node_ne tot btwn).assumptions st →
...
@[invProof] theorem Ring.recv_single_leader :
      ∀ (st st' : @State node),
        (@System node node_dec node_ne tot btwn).assumptions st →
          (@System node node_dec node_ne tot btwn).inv st →
...
/-- info:
@[invProof]
  theorem Ring.recv_single_leader :
      ∀ (st st' : @State node),
        (@System node node_dec node_ne tot btwn).assumptions st →
          (@System node node_dec node_ne tot btwn).inv st →
            (@Ring.recv.tr node node_dec node_ne tot btwn) st st' →
...
@[invProof] theorem Ring.recv_inv_1 :
      ∀ (st st' : @State node),
        (@System node node_dec node_ne tot btwn).assumptions st →
          (@System node node_dec node_ne tot btwn).inv st →
            (@Ring.recv.tr node node_dec node_ne tot btwn) st st' →
...
@[invProof] theorem Ring.recv_inv_2 :
      ∀ (st st' : @State node),
        (@System node node_dec node_ne tot btwn).assumptions st →
          (@System node node_dec node_ne tot btwn).inv st →
            (@Ring.recv.tr node node_dec node_ne tot btwn) st st' →
