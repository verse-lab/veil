...
@[veil]
theorem Phase2a_TypeOK (ρ : Type) (σ : Type) (acceptor : Type) [acceptor_dec_eq : DecidableEq.{1} acceptor]
  ...
  by
  unveil
  -- Phase2a doesn't modify maxBal or maxVBal, so TypeOK is preserved
  -- TypeOK: ∀ a, tot.le (maxVBal a) (maxBal a)
  intro _ _ _ _ _ _ _ _ a
