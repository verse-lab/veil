...
theorem Phase1a_MsgInv2b (ρ : Type) (σ : Type) (acceptor : Type) [acceptor_dec_eq : DecidableEq.{1} acceptor]
  ...
  by
  unveil
  -- Phase1a only adds a Phase1a message; any Phase2b message was in pre-state
  ...
  -- ma is also not the new Phase1a message
