...
theorem initializer_VotedOnce (ρ : Type) (σ : Type) (acceptor : Type) [acceptor_dec_eq : DecidableEq.{1} acceptor]
  ...
  by
  unveil
  -- VotedOnce holds vacuously because msgs is empty, so VotedForIn is false
  intro m hcontains
