...
@[veil]
theorem initializer_MsgInv2a (ρ : Type) (σ : Type) (acceptor : Type) [acceptor_dec_eq : DecidableEq.{1} acceptor]
    ...
    Veil.VeilM.meetsSpecificationIfSuccessfulAssuming
      ...
      (fun _ _ => True)
      (@MsgInv2a ρ σ acceptor acceptor_dec_eq acceptor_inhabited value value_dec_eq value_inhabited quorum quorum_dec_eq
  ...
  by
  unveil
  -- MsgInv2a holds vacuously because msgs is empty
  intro hcontains
