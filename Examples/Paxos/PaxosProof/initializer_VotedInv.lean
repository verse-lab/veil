...
@[veil]
theorem initializer_VotedInv (ρ : Type) (σ : Type) (acceptor : Type) [acceptor_dec_eq : DecidableEq.{1} acceptor]
    ...
    Veil.VeilM.meetsSpecificationIfSuccessfulAssuming
      ...
      (fun _ _ => True)
      (@VotedInv ρ σ acceptor acceptor_dec_eq acceptor_inhabited value value_dec_eq value_inhabited quorum quorum_dec_eq
  ...
  by
  unveil
  -- VotedInv holds vacuously because msgs is empty, so VotedForIn is false
  intro m hcontains
