...
#gen_reachable_invariants with phase := Nat, state_value := state_value
...
noncomputable abbrev System' :=
  relationalTransitionSystem node set_majority set_f_plus_1 phase proposal_value state_value
