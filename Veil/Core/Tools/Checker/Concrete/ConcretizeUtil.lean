...
def BinderSpec.forLawful : Array BinderSpec := #[.inst ``Veil.Enumeration, .inst ``Ord]
...
def BinderSpec.forInhabitedState : Array BinderSpec :=
  ...
  #[.typeExplicit, .inst ``Ord, .inhabited, .decEq, .inst ``Veil.Enumeration]
