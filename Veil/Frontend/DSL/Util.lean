...
/-- Name of the TR-style preservation theorem for `actName` and `invName`,
generated by `mkMeetsSpecificationIfSuccessfulClauseTrVC` and consumed by
`#gen_reachable_invariants`. -/
def trTheoremName (actName invName : Name) : Name :=
